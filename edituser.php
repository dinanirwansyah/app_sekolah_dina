...
if(isset($_POST['simpan'])){
    ...
    if($password1 != "" && $password2 !=""){
        if($password1 == $password2){
            ...
            $up = mysqli_query($conn,"update tbuser set nama_user='$username',password='$pass' where iduser=$iduser");
        }else{
...
<tr>
    <td>Password</td>
    <input type="password" name="password1"panceholder="password">
</td>
</tr>
<tr>
    <td>Konfirmasi Password</td>
    <td>
    <input type="password" name="password2"panceholder="password">
</td>
</td>
</tr>
<tr>
